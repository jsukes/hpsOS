#ifndef _ALTERA_HPS_0_TXRXDE0_H_
#define _ALTERA_HPS_0_TXRXDE0_H_
...
#define PIO_H2F_READ_ADDR_SPAN 16
#define PIO_H2F_READ_ADDR_END 0x3f
...
#define SYSID_QSYS_TIMESTAMP 1546620082
...
#define PIO_F2H_GPIO0_SPAN 16
#define PIO_F2H_GPIO0_END 0x1001f
...
#define PIO_F2H_GPIO1_SPAN 16
#define PIO_F2H_GPIO1_END 0x1003f
...
#define PIO_H2F_RECORD_LENGTH_SPAN 16
#define PIO_H2F_RECORD_LENGTH_END 0x1005f
...
#define PIO_H2F_TRIG_DELAY_SPAN 16
#define PIO_H2F_TRIG_DELAY_END 0x1007f
...
#define PIO_F2H_TRANSMIT_READY_SPAN 16
#define PIO_F2H_TRANSMIT_READY_END 0x1011f
...
#define PIO_H2F_FPGA_STATE_RESET_SPAN 16
#define PIO_H2F_FPGA_STATE_RESET_END 0x1013f
...
#define PIO_F2H_TRIG_COUNT_SPAN 16
#define PIO_F2H_TRIG_COUNT_END 0x1015f
...
#define PIO_F2H_FPGA_STATE_SPAN 16
#define PIO_F2H_FPGA_STATE_END 0x1017f
...
/*
 * Macros for device 'pio_arduino_trig_delay', class 'altera_avalon_pio'
 * The macros are prefixed with 'PIO_ARDUINO_TRIG_DELAY_'.
 * The prefix is the slave descriptor.
 */
#define PIO_ARDUINO_TRIG_DELAY_COMPONENT_TYPE altera_avalon_pio
#define PIO_ARDUINO_TRIG_DELAY_COMPONENT_NAME pio_arduino_trig_delay
#define PIO_ARDUINO_TRIG_DELAY_BASE 0x10210
#define PIO_ARDUINO_TRIG_DELAY_SPAN 16
#define PIO_ARDUINO_TRIG_DELAY_END 0x1021f
#define PIO_ARDUINO_TRIG_DELAY_BIT_CLEARING_EDGE_REGISTER 0
#define PIO_ARDUINO_TRIG_DELAY_BIT_MODIFYING_OUTPUT_REGISTER 0
#define PIO_ARDUINO_TRIG_DELAY_CAPTURE 0
#define PIO_ARDUINO_TRIG_DELAY_DATA_WIDTH 32
#define PIO_ARDUINO_TRIG_DELAY_DO_TEST_BENCH_WIRING 0
#define PIO_ARDUINO_TRIG_DELAY_DRIVEN_SIM_VALUE 0
#define PIO_ARDUINO_TRIG_DELAY_EDGE_TYPE NONE
#define PIO_ARDUINO_TRIG_DELAY_FREQ 50000000
#define PIO_ARDUINO_TRIG_DELAY_HAS_IN 0
#define PIO_ARDUINO_TRIG_DELAY_HAS_OUT 1
#define PIO_ARDUINO_TRIG_DELAY_HAS_TRI 0
#define PIO_ARDUINO_TRIG_DELAY_IRQ_TYPE NONE
#define PIO_ARDUINO_TRIG_DELAY_RESET_VALUE 0

/*
 * Macros for device 'pio_arduino_comms', class 'altera_avalon_pio'
 * The macros are prefixed with 'PIO_ARDUINO_COMMS_'.
 * The prefix is the slave descriptor.
 */
#define PIO_ARDUINO_COMMS_COMPONENT_TYPE altera_avalon_pio
#define PIO_ARDUINO_COMMS_COMPONENT_NAME pio_arduino_comms
#define PIO_ARDUINO_COMMS_BASE 0x10250
#define PIO_ARDUINO_COMMS_SPAN 16
#define PIO_ARDUINO_COMMS_END 0x1025f
#define PIO_ARDUINO_COMMS_BIT_CLEARING_EDGE_REGISTER 0
#define PIO_ARDUINO_COMMS_BIT_MODIFYING_OUTPUT_REGISTER 0
#define PIO_ARDUINO_COMMS_CAPTURE 0
#define PIO_ARDUINO_COMMS_DATA_WIDTH 8
#define PIO_ARDUINO_COMMS_DO_TEST_BENCH_WIRING 0
#define PIO_ARDUINO_COMMS_DRIVEN_SIM_VALUE 0
#define PIO_ARDUINO_COMMS_EDGE_TYPE NONE
#define PIO_ARDUINO_COMMS_FREQ 50000000
#define PIO_ARDUINO_COMMS_HAS_IN 0
#define PIO_ARDUINO_COMMS_HAS_OUT 1
#define PIO_ARDUINO_COMMS_HAS_TRI 0
#define PIO_ARDUINO_COMMS_IRQ_TYPE NONE
#define PIO_ARDUINO_COMMS_RESET_VALUE 0
...
#define ONCHIP_MEMORY2_1_END 0x4ffff
...
/*
 * Macros for device 'onchip_memory2_2', class 'altera_avalon_onchip_memory2'
 * The macros are prefixed with 'ONCHIP_MEMORY2_2_'.
 * The prefix is the slave descriptor.
 */
#define ONCHIP_MEMORY2_2_COMPONENT_TYPE altera_avalon_onchip_memory2
#define ONCHIP_MEMORY2_2_COMPONENT_NAME onchip_memory2_2
#define ONCHIP_MEMORY2_2_BASE 0x50000
#define ONCHIP_MEMORY2_2_SPAN 32768
#define ONCHIP_MEMORY2_2_END 0x57fff
...
#define ONCHIP_MEMORY2_2_DUAL_PORT 1
#define ONCHIP_MEMORY2_2_GUI_RAM_BLOCK_TYPE AUTO
#define ONCHIP_MEMORY2_2_INIT_CONTENTS_FILE soc_system_onchip_memory2_2
...
#define ONCHIP_MEMORY2_2_SIZE_VALUE 32768
#define ONCHIP_MEMORY2_2_WRITABLE 1
#define ONCHIP_MEMORY2_2_MEMORY_INFO_DAT_SYM_INSTALL_DIR SIM_DIR
#define ONCHIP_MEMORY2_2_MEMORY_INFO_GENERATE_DAT_SYM 1
#define ONCHIP_MEMORY2_2_MEMORY_INFO_GENERATE_HEX 1
#define ONCHIP_MEMORY2_2_MEMORY_INFO_HAS_BYTE_LANE 0
#define ONCHIP_MEMORY2_2_MEMORY_INFO_HEX_INSTALL_DIR QPF_DIR
#define ONCHIP_MEMORY2_2_MEMORY_INFO_MEM_INIT_DATA_WIDTH 16
#define ONCHIP_MEMORY2_2_MEMORY_INFO_MEM_INIT_FILENAME soc_system_onchip_memory2_2

/*
 * Macros for device 'onchip_memory2_3', class 'altera_avalon_onchip_memory2'
 * The macros are prefixed with 'ONCHIP_MEMORY2_3_'.
 * The prefix is the slave descriptor.
 */
#define ONCHIP_MEMORY2_3_COMPONENT_TYPE altera_avalon_onchip_memory2
#define ONCHIP_MEMORY2_3_COMPONENT_NAME onchip_memory2_3
#define ONCHIP_MEMORY2_3_BASE 0x60000
#define ONCHIP_MEMORY2_3_SPAN 65536
#define ONCHIP_MEMORY2_3_END 0x6ffff
...
#define ONCHIP_MEMORY2_3_DUAL_PORT 1
#define ONCHIP_MEMORY2_3_GUI_RAM_BLOCK_TYPE AUTO
#define ONCHIP_MEMORY2_3_INIT_CONTENTS_FILE soc_system_onchip_memory2_3
...
#define ONCHIP_MEMORY2_3_SIZE_VALUE 65536
#define ONCHIP_MEMORY2_3_WRITABLE 1
#define ONCHIP_MEMORY2_3_MEMORY_INFO_DAT_SYM_INSTALL_DIR SIM_DIR
#define ONCHIP_MEMORY2_3_MEMORY_INFO_GENERATE_DAT_SYM 1
#define ONCHIP_MEMORY2_3_MEMORY_INFO_GENERATE_HEX 1
#define ONCHIP_MEMORY2_3_MEMORY_INFO_HAS_BYTE_LANE 0
#define ONCHIP_MEMORY2_3_MEMORY_INFO_HEX_INSTALL_DIR QPF_DIR
#define ONCHIP_MEMORY2_3_MEMORY_INFO_MEM_INIT_DATA_WIDTH 32
#define ONCHIP_MEMORY2_3_MEMORY_INFO_MEM_INIT_FILENAME soc_system_onchip_memory2_3

/*
 * Macros for device 'pio_arduino_trig_num', class 'altera_avalon_pio'
 * The macros are prefixed with 'PIO_ARDUINO_TRIG_NUM_'.
 * The prefix is the slave descriptor.
 */
#define PIO_ARDUINO_TRIG_NUM_COMPONENT_TYPE altera_avalon_pio
#define PIO_ARDUINO_TRIG_NUM_COMPONENT_NAME pio_arduino_trig_num
#define PIO_ARDUINO_TRIG_NUM_BASE 0x100230
#define PIO_ARDUINO_TRIG_NUM_SPAN 16
#define PIO_ARDUINO_TRIG_NUM_END 0x10023f
#define PIO_ARDUINO_TRIG_NUM_BIT_CLEARING_EDGE_REGISTER 0
#define PIO_ARDUINO_TRIG_NUM_BIT_MODIFYING_OUTPUT_REGISTER 0
#define PIO_ARDUINO_TRIG_NUM_CAPTURE 0
#define PIO_ARDUINO_TRIG_NUM_DATA_WIDTH 16
#define PIO_ARDUINO_TRIG_NUM_DO_TEST_BENCH_WIRING 0
#define PIO_ARDUINO_TRIG_NUM_DRIVEN_SIM_VALUE 0
#define PIO_ARDUINO_TRIG_NUM_EDGE_TYPE NONE
#define PIO_ARDUINO_TRIG_NUM_FREQ 50000000
#define PIO_ARDUINO_TRIG_NUM_HAS_IN 0
#define PIO_ARDUINO_TRIG_NUM_HAS_OUT 1
#define PIO_ARDUINO_TRIG_NUM_HAS_TRI 0
#define PIO_ARDUINO_TRIG_NUM_IRQ_TYPE NONE
#define PIO_ARDUINO_TRIG_NUM_RESET_VALUE 0


#endif /* _ALTERA_HPS_0_TXRXDE0_H_ */
