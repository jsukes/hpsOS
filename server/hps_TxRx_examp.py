...
trig_state = (1<<6)
output_state1 = ( 0xff )
output_state2 = ( 0xff ^ trig_state )
outputOff_state = 0x00
...
for n in range(0,NTRIG_EVENTS):
	...
	if ( n == 0 ):
		...
		d.setArdTrigVal(n,outputOff_state)
		#~ d.setArdTrigWait(n,n*0.5)
		d.setArdTrigWait(n,n*0.5)
...
#~ d.setArdTrigVal(NTRIG_EVENTS+1,0) # turn off all the trigger outputs at the end
#~ d.setArdTrigWait(NTRIG_EVENTS+1,1) # issue the necessary wait command for the last trigger
